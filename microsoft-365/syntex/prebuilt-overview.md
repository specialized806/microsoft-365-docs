...
For information about requirements to consider when choosing this model, see the [requirements and limitations for prebuilt document processing](requirements-and-limitations.md#prebuilt-document-process).
