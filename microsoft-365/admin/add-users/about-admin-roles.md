...
|People admin |   Assign the People administrator role to users who need to do the following tasks: <br> &bull; Update profile photos for all users including administrators<br> &bull; Update people settings for all users (pronouns, name pronunciation, and people card settings)|
